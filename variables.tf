...
variable "subscription_id" {
  ...
  type        = string
  default     = "c5d43e46-3c8c-44d4-bb60-f3ba38da13ef"
}
...
variable "dcr_vminsights_name" {
  ...
  type        = string
  default     = "MSVMI-DefaultWorkspace-c5d43e46-3c8c-44d4-bb60-f3ba38da13ef-EUS"
}
...
variable "vip_support_action_group_id" {
  ...
  type        = string
  default     = "/subscriptions/c5d43e46-3c8c-44d4-bb60-f3ba38da13ef/resourcegroups/r-csspz-rg-man-prd-009/providers/microsoft.insights/actiongroups/vipsupport"
}
...
variable "automation_account_id" {
  ...
  type        = string
  default     = "/subscriptions/c5d43e46-3c8c-44d4-bb60-f3ba38da13ef/resourceGroups/M-CSSPZ-RG-MAN-PRD-001/providers/Microsoft.Automation/automationAccounts/aut-azure-servicenow-001"
}
...
variable "common_tags_PRD" {
  description = "Common tags for PRD to apply to all resources"
  type        = map(string)
  default = {
    "Account Type"            = "PLACEHOLDER"
    "App Support"             = "PLACEHOLDER"
...
variable "saved_search_categories" {
  ...
  default = {
    ...
    change_tracking_          = "ChangeTracking"
