...
resource "azurerm_monitor_data_collection_rule" "res-1" {
  ...
  data_sources {
    performance_counter {
      ...
      streams                       = ["Microsoft-InsiaghtsMetrics"]
    }
  }
  destinations {
    log_analytics {
...
resource "azurerm_log_analytics_saved_search" "res-7" {
  ...
  name                       = "ChangeTracking_AllChanges"
...
resource "azurerm_log_analytics_saved_search" "res-8" {
  ...
  log_analytics_workspace_id = local.log_analytics_workspace_id
  name                       = "ChangeTracking_ChangeTypePerComputer"
...
resource "azurerm_log_analytics_saved_search" "res-9" {
  ...
  log_analytics_workspace_id = local.log_analytics_workspace_id
  name                       = "ChangeTracking_ServiceChanges"
...
resource "azurerm_log_analytics_saved_search" "res-10" {
  ...
  log_analytics_workspace_id = local.log_analytics_workspace_id
  name                       = "ChangeTracking_SoftwareChangeCount"
...
resource "azurerm_log_analytics_saved_search" "res-11" {
  ...
  log_analytics_workspace_id = local.log_analytics_workspace_id
  name                       = "ChangeTracking_SoftwareChanges"
...
resource "azurerm_log_analytics_saved_search" "res-91" {
  ...
  log_analytics_workspace_id = local.log_analytics_workspace_id
  name                       = "Security_SecurityWarningNotableIssues|ComputersWithSystemAuditPolicyChanges"
...
resource "azurerm_log_analytics_saved_search" "res-98" {
  category                   = var.saved_search_categories.change_tracking_
